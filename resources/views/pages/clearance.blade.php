...
<div class="bidb-wrap">
  ...
  <div class="card" style="position:sticky;top:20px">
    ...
    <div class="card-body" style="padding:18px">
      <form action="{{ route('clearance.store') }}" method="POST" id="cl-form">
        @csrf
        <input type="hidden" name="body_content" id="cl-body-hidden">

        <div class="form-group">
          <label>Document Type <span class="req">*</span></label>
          <select name="certificate_type" id="cl-type-select" required onchange="clUpdate()">
        ...
        <div class="form-group">
          ...
          <input type="hidden" name="resident_name" id="cl-resident-name" required>
          <button type="button" class="res-picker-btn" id="cl-picker-btn" onclick="openResPicker('clearance')">
            <span id="cl-picker-label" class="placeholder">Click to select a resident...</span>
        ...
        <div class="form-group">
          ...
          <select name="civil_status" id="cl-civil-status" onchange="clUpdate()">
        ...
        <div class="form-group">
          ...
          <input type="text" name="purok" id="cl-purok" placeholder="e.g. Sampaguita" oninput="clUpdate()">
        </div>
        </div>

        <div class="form-group">
          <label>Requestor</label>
          <select name="requestor" id="cl-requestor" onchange="clUpdate()">
        ...
        <div style="border-top:1px solid var(--border);padding-top:12px;margin-top:4px">
          ...
          <div class="form-group" style="margin-bottom:8px">
            ...
            <input type="text" name="or_number" id="cl-or-number" placeholder="e.g. 8954164" oninput="clUpdate()">
          </div>
          <div class="form-group" style="margin-bottom:8px">
            <label>Amount (₱)</label>
            <input type="number" name="amount" id="cl-amount" step="0.01" min="0" placeholder="0.00" oninput="clUpdate()">
          </div>
          </div>
        </div>
      ...
      <div style="background:#fff;color:#000;width:100%;max-width:680px;min-height:900px;padding:50px 60px;box-shadow:0 4px 20px rgba(0,0,0,.15);font-family:'Times New Roman',serif;font-size:15px;line-height:1.9;display:flex;flex-direction:column">
        ...
        <div style="margin-bottom:14px;flex:1">
          <div class="doc-toolbar">
            ...
            <button type="button" onclick="clUpdate()" title="Regenerate body from current form values"
